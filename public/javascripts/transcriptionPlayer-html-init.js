/*!
 * transcription-player 1.0.0 (2020-06-04)
 * https://github.com/gstefanic/transcription-player.js
 * @license MIT
 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["TranscriptionPlayer"] = root["TranscriptionPlayer"] || {}, root["TranscriptionPlayer"]["html-init"] = factory();
})(this, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/html-init.js");
/******/ })
/************************************************************************/
/******/ ({
...
var Init = /*#__PURE__*/function () {
   ...
   */
  function Init(TranscriptionPlayer) {
    ...
    var _params = this.params = Object.assign({}, {
      ...
      pluginCdnTemplate: '//localhost:8080/dist/plugin/transcriptionPlayer.[name].js',
      ...
      loadPlugin: function loadPlugin(name, cb) {
        ...
        (0, _loadScript.default)(src, {
          ...
          if (err) {
            ...
            return console.error("TranscriptionPlayer plugin ".concat(name, " not found at ").concat(src));
          }
  ...
  _createClass(Init, [{
    ...
    value: function initEl(el) {
      ...
      el.style.display = 'block'; // initialize TranscriptionPlayer, load audio and transcription

      var instance = this.TranscriptionPlayer.create(params);
      instance.load(params.audioUrl, params.transcriptionUrl); // push this instance into the instances cache
...
if ((typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object' && !window.TP_StopAutoInit) {
  // call init when document is ready, apply any custom default settings
  // in window.TP_InitOptions
  if (document.readyState === 'complete') {
    window.TranscriptionPlayerInit = new Init(window.TranscriptionPlayer, window.TP_InitOptions);
  } else {
...
//# sourceMappingURL=transcriptionPlayer-html-init.js.map